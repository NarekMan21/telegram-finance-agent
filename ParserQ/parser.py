...
async def fetch_history():
    ...
    for group_id in GROUP_IDS:
        try:
            ...
            async for message in client.iter_messages(entity=group_id, reverse=True, offset_date=since_date):
...
async def main():
    ...
    if PHONE_NUMBER == '+1234567890' or not PHONE_NUMBER.startswith('+'):
        logger.error("Update phone_number in config.json before first run")
        return
